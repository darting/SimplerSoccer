 ...
 case Msg_Wait:
  ...
  case Msg_PassToMe:
    {  
      ...
      std::cout << "Player " << player->ID() << " received request from " <<
                    receiver->ID() << " to make pass" << std::endl;
      #endif
      ...
      {
        #ifdef PLAYER_STATE_INFO_ON
        std::cout << "Player " << player->ID() << " cannot make requested pass <cannot kick ball>" << "";
        #endif
     ...
     #ifdef PLAYER_STATE_INFO_ON
	  std::cout << "Player " << player->ID() << " Passed ball to requesting player" << "";
     #endif
...
void ChaseBall::Enter(FieldPlayer* player)
{
  ...
  #ifdef PLAYER_STATE_INFO_ON
  std::cout << "Player " << player->ID() << " enters chase state" << "";
  #endif
}
...
void SupportAttacker::Enter(FieldPlayer* player)
{
  ...
  #ifdef PLAYER_STATE_INFO_ON
  std::cout << "Player " << player->ID() << " enters support state" << "";
  #endif
}
...
void ReturnToHomeRegion::Enter(FieldPlayer* player)
{
  ...
  #ifdef PLAYER_STATE_INFO_ON
  std::cout << "Player " << player->ID() << " enters ReturnToHome state" << "";
  #endif
}
...
{
  #ifdef PLAYER_STATE_INFO_ON
	std::cout << "Player " << player->ID() << " enters wait state" << "";
  #endif
...
void KickBall::Enter(FieldPlayer* player)
{
  ...
  #ifdef PLAYER_STATE_INFO_ON
   std::cout << "Player " << player->ID() << " enters kick state" << "";
  #endif
}
...
{ 
  ...
  {
    #ifdef PLAYER_STATE_INFO_ON
	  std::cout << "Goaly has ball / ball behind player" << "";
    #endif
  ...
  {
   #ifdef PLAYER_STATE_INFO_ON
	  std::cout << "Player " << player->ID() << " attempts a shot at " << BallTarget << "";
   #endif
  ...
  {     
    ...
    #ifdef PLAYER_STATE_INFO_ON
	std::cout << "Player " << player->ID() << " passes the ball with force " << power << "  to player "
...
#ifdef PLAYER_STATE_INFO_ON
  std::cout << "Player " << player->ID() << " enters dribble state" << "";
  #endif
}
...
void ReceiveBall::Enter(FieldPlayer* player)
{
     ...
     !player->Team()->isOpponentWithinRadius(player->Pos(), PassThreatRadius))
  {
    ...
    #ifdef PLAYER_STATE_INFO_ON
	std::cout << "Player " << player->ID() << " enters receive state (Using Arrive)" << "";
    #endif
  }
  else
  {
    ...
    #ifdef PLAYER_STATE_INFO_ON
	std::cout << "Player " << player->ID() << " enters receive state (Using Pursuit)" << "";
    #endif
  }
}
